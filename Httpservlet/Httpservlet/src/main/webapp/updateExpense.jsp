...
<body>
	<form method="post" action="UpdateExpense">
		...
		<div class="main">
			...
			Expense ex= expenseService.findExpenseById(eid);
				
			%>
			
			<div class="right">
				<h3>Update Expenses</h3>
				<input value=<%=ex.getExpenseid()%> name="eId" hidden>
				<input type="text" placeholder="Amount" name="amount" value=<%=ex.getAmount() %>><br><br>
				<input type="date" name="date" value=<%=ex.getDate() %>><br><br>
				
				<input type="text" placeholder="Category" name="category" list="sub" value="<%=ex.getCategory() %>"><br><br>
				<datalist id="sub">
				...
				<textarea  placeholder="Description" id="desc" name="description"><%=ex.getDescription()%></textarea>
